...
public class ContactsController : ControllerBase
{
    ...
    [HttpGet("{IsDefault}/{Information}")]
    public async Task<ApiResponse<List<ContactResponse>>> Get(bool IsDefault, string Information)
    {
        var operation = new GetContactByParameterQuery(IsDefault, Information);
        var result = await mediator.Send(operation);
        return result;
    }
